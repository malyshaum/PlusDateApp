...
use App\Http\Commands\ClearNotificationsCommand;
use App\Http\Commands\ClearSwipesCommand;
use App\Http\Commands\DeleteProfileCommand;
...
return [
    ...
    */
    ...
    'moderation_bot' => [
        'token' => env('TELEGRAM_MODERATION_BOT_TOKEN'),
